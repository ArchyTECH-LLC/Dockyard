...
namespace ApiSdk.Models
{
    ...
    public class MethodInfo : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.ParameterInfo? ReturnParameter { get; set; }
#nullable restore
#else
        public ApiSdk.Models.ParameterInfo ReturnParameter { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.TypeObject? ReturnType { get; set; }
#nullable restore
#else
        public ApiSdk.Models.TypeObject ReturnType { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.ICustomAttributeProvider? ReturnTypeCustomAttributes { get; set; }
#nullable restore
#else
        public ApiSdk.Models.ICustomAttributeProvider ReturnTypeCustomAttributes { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MethodInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.MethodInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MethodInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "returnParameter", n => { ReturnParameter = n.GetObjectValue<ApiSdk.Models.ParameterInfo>(ApiSdk.Models.ParameterInfo.CreateFromDiscriminatorValue); } },
                { "returnType", n => { ReturnType = n.GetObjectValue<ApiSdk.Models.TypeObject>(ApiSdk.Models.TypeObject.CreateFromDiscriminatorValue); } },
                { "returnTypeCustomAttributes", n => { ReturnTypeCustomAttributes = n.GetObjectValue<ApiSdk.Models.ICustomAttributeProvider>(ApiSdk.Models.ICustomAttributeProvider.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.ParameterInfo>("returnParameter", ReturnParameter);
            writer.WriteObjectValue<ApiSdk.Models.TypeObject>("returnType", ReturnType);
            writer.WriteObjectValue<ApiSdk.Models.ICustomAttributeProvider>("returnTypeCustomAttributes", ReturnTypeCustomAttributes);
        }
    }
}
